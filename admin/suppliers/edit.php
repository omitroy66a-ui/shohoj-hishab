...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $conn->query("UPDATE suppliers SET name='$name', phone='$phone', email='$email', address='$address', opening_due='$opening_due' WHERE id=$id");
...
<head>
    <meta charset="utf-8">
    <title>Edit Supplier - Sohoj Hishab</title>
...
<body>
    <div class="container">
        ...
        <form method="post">
            ...
            <input type="number" step="0.01" id="opening_due" name="opening_due" value="<?php echo htmlspecialchars($supplier['opening_due']); ?>">
